#!/usr/bin/env bash
# Applique l'identite NolFox sur l'arbre de sources : branding derive
...
# Branding : copie de la base unofficial, renommee NolFox
...
# Prefs NolFox ajoutees aux defaults du branding
cat prefs/nolfox.js >> "$SRC/browser/branding/nolfox/pref/firefox-branding.js"

# mozconfig + policies d'entreprise embarquees
